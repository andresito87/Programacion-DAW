 ...
 * Tambi�n incluye un par de métodos para simplificar la escritura de mensajes
...
public class ES {
     ...
     * el valor suministrado está en ese rango.
     *
     ...
     * suministrado está en ese rango.
     *
     ...
     * se estará repitiendo hasta que el valor suministrado está en ese rango.
     *
     * @param mensaje  Es el mensaje que se muestra para solicitar la
     * introducción del número.
     * @param minimo  Es el valor más pequeño dentro del rango de los números
     ...
     * que el valor suministrado está en ese rango.
     *
     * @param minimo Es el valor más pequeño dentro del rango de los números
     * enteros tipo int que se aceptará como válido.
    ...
    public static int leeEntero(int minimo, int maximo) throws IllegalArgumentException {
        ...
        // Si el valor mínimo es mayor que el máximo, lanzamos una excepci�n
        if (minimo <= maximo) {
            do {
                try {
                    teclado = new Scanner(System.in);
     ...
     * lectura se estará repitiendo hasta que el valor suministrado está en ese
     * rango.
     *
     * @param mensaje Es el mensaje que se muestra para solicitar la
     * introducción del número.
        ...
        do {
            ...
            try {
                ...
                if ( cadena!= null && cadena.length() == 1 && ((cadena.equalsIgnoreCase("S")) || (cadena.equalsIgnoreCase("N")))) {
                    ...
                    ES.msgln("Error: Solo se admite como respuesta un �nico carácter, que debe ser 's', 'S', 'n' o 'N'.");
                }
            } catch (Exception e) {
                ES.msgln("Error: Ha fallado la entrada de datos.");
            }
