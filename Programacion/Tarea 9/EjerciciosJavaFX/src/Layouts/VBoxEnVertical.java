 ...
 * @author JJBH
 */
public class VBoxEnVertical extends Application {
    ...
    public void start(Stage stage) {
        // Asignar 50 póxeles de separación entre los nodos
        caja = new VBox(50);
        // Agregar un relleno de 30 píxeles para separarlo del borde de la ventana
